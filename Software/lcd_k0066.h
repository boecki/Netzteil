#ifndef LCD_KS0066_4BIT_IO_H
#define LCD_KS0066_4BIT_IO_H
/*************************************************************************
...
#define LCD_VCC_PORT	 LCD_PORT	  /**< port for powersupply		*/
#define LCD_VCC_PIN		 7			  /**< pin  for powersupply		*/	

/*************************************************************************
 *  name Definitions for LCD command instructions
 *  The constants define the various LCD controller instructions which can be passed to the 
 *  function lcd_command(), see KS0066U data sheet for a complete description.
***************************************************************************/
